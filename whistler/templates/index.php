                        ...
                        <table class="alignleft">
                          ...
                          <script type='text/javascript'>
						  		if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
									document.write("<p style='padding-top: 4px;'>WE NOTICE THAT YOU ARE ON A MOBILE DEVICE.  PLEASE BE PATIENT WHILE THE VIDEO LOADS</p>");
								}
							</script>
                          </td><td style="vertical-align: text-top"><div style="background : transparent; color : #000000; padding : 4px; width : 300px; height : 356px; overflow : auto; "><?php echo $html_playlist_code; ?></div></td></tr>
